...
export class FinancPagarService {
  ...
  buscarClientes(query: string): Observable<any[]> {
    ...
    BaixarParcela(subFinancPagar : SubFinancPagar) : Observable<ResponseModel<SubFinancPagar>>{
      return this.http.put<ResponseModel<SubFinancPagar>>(`${this.baseURL}BaixarParcela`,subFinancPagar)
    }
   ...
   ListarSintetico(
      ...
      return this.http.get<ResponseModel<SubFinancPagar[]>>(`${this.baseURL}ListarSintetico`, { params });
    }
